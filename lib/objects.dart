...
class ObjectButton extends StatefulWidget {
  ObjectButton({
    required this.object,required this.onPressed,
  });
  final String object;
...
class _ObjectButtonState extends State<ObjectButton> {
  createObject() {
    switch (widget.object) {
      case "Blinker":
        return Objects.createBlinker();
      case "Uhr":
        return Objects.createUhr();
      case "Kröte":
        return Objects.createKroete();
      case "Bipole":
        return Objects.createBipole();
      case "Tripole":
        return Objects.createTripole();
      case "Pulsator":
        return Objects.createPulsator();
      case "Tümmler":
        return Objects.createTuemmler();
      case "Oktagon":
        return Objects.createOktagon();
      case "Gleiter":
        return Objects.createGleiter();
      case "Segler1":
        return Objects.createSegler1();
      case "Segler2":
        return Objects.createSegler2();
      case "Segler3":
        return Objects.createSegler3();
      case "r-Pentomino":
        return Objects.createRPentomino();
      default:
        return () {};
    }
  }
...
mixin Objects {
  static int start =
      (columnLength / 2).round() * rowLength - (rowLength / 2).round();
